            ...
            <div class="col-md-12">
                <div class="login-content">
                    ...
                    <div class="social-sign">
                        <a href="/login/github"><i class="fa fa-facebook"></i> Sign in GitHub</a>
                        <a href="/login/facebook"><i class="fa fa-facebook"></i> Sign in with facebook</a>
                        <a href="/login/google"><i class="fa fa-facebook"></i> Sign in with google</a>
