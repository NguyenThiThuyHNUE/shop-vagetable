        ...
        <div class="row">
            <div class="col-md-12">
                <div class="login-content">
                    ...
                    <form method="POST" action="{{ route('home.user.storeProfile') }}" enctype="multipart/form-data">
                        @csrf
                        <label>Full Name</label>
                        <input type="text" name="profileName" autofocus />
                        @if($errors-> has('profileName'))
                            <span class="text-danger">{{$errors->first('profileName')}}</span>
                        @endif
                        <label> Your Phone</label>
                        <input type="number" name="profilePhone"/>
                        @if($errors-> has('profilePhone'))
                            <span class="text-danger">{{$errors->first('profilePhone')}}</span>
                        @endif
